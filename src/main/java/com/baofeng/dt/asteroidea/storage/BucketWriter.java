...
class BucketWriter {
  ...
  private volatile String oldFileName;
...
//  private SinkCounter sinkCounter;
  ...
  private final HDFSStorage.WriterCallback onCloseCallback;
  ...
  BucketWriter(long rollInterval, long rollSize, long rollCount, long batchSize,
               ...
               ScheduledExecutorService timedRollerPool, int idleTimeout, HDFSStorage.WriterCallback closeCallback,
...
//        sinkCounter.incrementConnectionFailedCount();
   ...
   * @throws InterruptedException
   */
  public synchronized void append(final byte[] event)
          throws IOException, InterruptedException, BucketClosedException {
    checkAndThrowInterruptedException();
  ...
  private boolean shouldRotate() {
    ...
    if(this.fileName != this.oldFileName){
      LOG.debug("rolling: oldfileName: {}, newFileName: {}", oldFileName, fileName);
      doRotate = true;
    }
  ...
  /**
   * Rename bucketPath file from .qpsTmp to permanent location.
   */
